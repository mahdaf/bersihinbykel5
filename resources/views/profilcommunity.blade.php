            ...
            <div class="bg-white rounded-2xl p-8 w-full max-w-md relative">
                ...
                <form method="POST" action="{{ route('profil.update') }}" enctype="multipart/form-data" class="flex flex-col gap-4">
                    ...
                    <div class="flex flex-col items-center gap-2">
                        <img id="preview-foto" src="{{ $user->fotoProfil ? asset('storage/' . $user->fotoProfil) : asset('img/default-profile.png') }}" alt="Foto Profil" class="w-24 h-24 rounded-full object-cover border mb-2">
