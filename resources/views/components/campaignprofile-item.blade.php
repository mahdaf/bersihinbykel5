<a href="#" class="block group">
    <div class="relative h-32 rounded-2xl overflow-hidden cursor-pointer transition-transform hover:scale-[1.02]">
        <img src="{{ asset('campaignprofile.jpg') }}" alt="Jalanan Bersih" class="w-full h-full object-cover" />
        ...
        <div class="absolute inset-0 flex items-center justify-between p-6">
            <div>
                <h3 class="text-white text-xl font-semibold mb-4">Jalanan Bersih</h3>
                <span class="px-3 py-1 rounded-full text-[12px] inline-flex items-center gap-1 bg-[#a68f5c] text-white">
